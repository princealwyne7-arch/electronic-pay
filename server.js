...
<head>
    ...
    <style>
        :root { --primary: #0f172a; --accent: #28a745; --bg: #f8fafc; --card: #ffffff; --red: #ef4444; --ai-color: #3b82f6; }
...
<body>
    ...
    <div id="aiOverlay">
        ...
        <div class="card" style="background:var(--primary); color:white; margin-top:20px; border-left:5px solid var(--ai-color);">
            <small style="opacity:0.7">LIVE PREDICTOR ENGINE</small>
            <h2 id="aiLivePredict" style="margin:5px 0; color:var(--ai-color);">KES --</h2>
            <div style="font-size:10px; color:#4ade80">● Neural Growth Scanning...</div>
        </div>
        <div class="a-grid">
            <div class="a-feat" onclick="playSfx(1)">⚡<b>Neural Boost</b><small>Accelerate Nodes</small></div>
            <div class="a-feat" onclick="playSfx(2)">🛡️<b>Deep Scan</b><small>AI Shielding</small></div>
            <div class="a-feat" onclick="playSfx(3)">🛰️<b>Node Logic</b><small>Route Optimization</small></div>
            <div class="a-feat" onclick="playSfx(4)">📈<b>Auto-Scaling</b><small>Enabled</small></div>
        </div>
    </div>
    ...
    <div class="side-drawer" id="drawer">
        ...
        <a class="drawer-item" onclick="openAiSystem()" style="background:rgba(59,130,246,0.1); border-left:3px solid var(--ai-color);">🧠 AI Command System</a>
    ...
    <div id="tab-dash" class="tab-content active-tab">
        ...
        <div class="card" id="adminControl" style="display:none; border: 2px solid var(--accent);">
            <h3 style="margin:0 0 10px 0; color:var(--accent);">Admin Command</h3>
    ...
    <div id="tab-vault" class="tab-content">
        <div class="card balance-card">
            <div style="display:flex; justify-content:space-between; align-items:center;">
                <div><small style="color:var(--accent); font-weight:800;">VAULT STATUS: <span id="vLockStatus">ENCRYPTED</span></small>
                <h2 id="vaultTotalDisplay" style="margin:5px 0; font-size:28px;">KES 0</h2></div>
    ...
    <div id="tab-insights" class="tab-content">
        ...
        <div class="intel-ticker"><span>BTC: $95,210.40 (+2.4%) | ETH: $2,550.12 | KES/USD: 129.50</span></div>
    ...
    <script>
        ...
        function closeAll() { document.getElementById('assetOverlay').classList.remove('active'); document.getElementById('aiOverlay').classList.remove('active'); document.getElementById('drawer').classList.remove('open'); document.getElementById('overlay').style.display = 'none'; }
        ...
        async function update() {
            try {
                ...
                document.getElementById('aiLivePredict').innerText = 'KES ' + Math.floor(data.todayTotal * 1.45).toLocaleString();
