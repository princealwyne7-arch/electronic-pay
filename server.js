...
<body>
    ...
    <div id="tab-insights" class="tab-content">
        ...
        <div class="intel-ticker"><span>BTC: $95,210 | KES/USD: 129.50 | USDT: $1.00</span></div>
        <div class="card">
    ...
    <script>
        ...
        function activateIntel(el, sfx) { playSfx(sfx); document.querySelectorAll('.intel-nav-item').forEach(i => i.classList.remove('active')); el.classList.add('active'); }
