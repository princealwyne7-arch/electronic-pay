...
// HTML Interface (Original UI + Sound Engine v15)
app.get('/', (req, res) => {
    res.send(\`
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="tab-insights" class="tab-content">
        ...
        <div class="intel-ticker">
            <span>BTC: $95,210.40 | ETH: $2,550.12 | KES/USD: 129.50 | USDT: $1.00</span>
        </div>
        <div class="card">
    ...
    <script>
        ...
        function activateIntel(el, sfx) { playSfx(sfx); document.querySelectorAll('.intel-nav-item').forEach(item => item.classList.remove('active')); el.classList.add('active'); el.scrollIntoView({ behavior: 'smooth', inline: 'center' }); }
