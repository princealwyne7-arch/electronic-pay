...
<body>
    ...
    <div id="assetOverlay">
        ...
        <div class="a-grid">
            ...
            <div class="a-feat" onclick="playSfx(2)">📈<b>Portfolio</b><small>Overview</small></div>
            ...
            <div class="a-feat" onclick="playSfx(5)">📤<b>Send</b><small>Transfer</small></div>
            <div class="a-feat" onclick="playSfx(6)">📜<b>Ledger</b><small>Sync</small></div>
            <div class="a-feat" onclick="playSfx(7)">📊<b>Market</b><small>Performance</small></div>
            <div class="a-feat" onclick="playSfx(8)">🔔<b>Alerts</b><small>Triggers</small></div>
            <div class="a-feat" onclick="playSfx(9)">🛡️<b>Security</b><small>Biometric</small></div>
            <div class="a-feat" onclick="playSfx(10)">🖼️<b>NFTs</b><small>Manager</small></div>
            <div class="a-feat" onclick="playSfx(11)">🥩<b>Staking</b><small>Yield</small></div>
            <div class="a-feat" onclick="playSfx(12)">💡<b>Analytics</b><small>AI Insights</small></div>
            <div class="a-feat" onclick="playSfx(13)">⚖️<b>Compliance</b><small>KYC</small></div>
            <div class="a-feat" onclick="playSfx(14)">🌍<b>Support</b><small>Multi-Fiat</small></div>
            <div class="a-feat" onclick="playSfx(15)">📥<b>Export</b><small>Tax Reports</small></div>
            <div class="a-feat" onclick="playSfx(1)">🔍<b>Search</b><small>Filter</small></div>
        </div>
    </div>
    ...
    <div id="tab-vault" class="tab-content">
        ...
        <div class="vault-grid">
            ...
            <div class="v-item" onclick="playSfx(8)">📝 Notes</div>
            <div class="v-item" onclick="playSfx(9)">🔒 Secret</div>
            <div class="v-item" onclick="playSfx(10)">🆔 Access</div>
            <div class="v-item" onclick="playSfx(11)">📡 Monitor</div>
            <div class="v-item" onclick="playSfx(12)">⏲️ Auto-Lock</div>
            <div class="v-item" onclick="playSfx(13)">📜 Activity Log</div>
            <div class="v-item" onclick="playSfx(14)">🛡️ Settings</div>
    ...
    <div id="tab-insights" class="tab-content">
        ...
        <div class="intel-ticker"><span>BTC: $95,210.40 | ETH: $2,550.12 | SOL: $148.20 | KES/USD: 129.50</span></div>
        <div class="card" style="border-left: 5px solid var(--accent);">
            <h3 style="margin:0;">📊 Intel Engine v3.0</h3>
            <div class="chart-container" id="pulseChart"></div>
            <div class="node-stat"><b>Network</b><span style="color:var(--accent)">Encrypted</span></div>
            <div class="node-stat"><b>Integrity</b><span style="color:var(--accent)">100%</span></div>
        </div>
    </div>
