...
<head>
    ...
    <style>
        ...
        #menuBtn { font-size:24px; cursor:pointer; padding: 5px; }
        .side-drawer { position:fixed; left:-280px; top:0; width:280px; height:100%; background:var(--primary); z-index:2000; transition:0.3s ease; padding:20px; box-sizing:border-box; color:white; }
        .side-drawer.open { left:0; }
        .overlay { position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); display:none; z-index:1999; }
        .drawer-item { padding:15px; border-bottom:1px solid rgba(255,255,255,0.1); display:flex; align-items:center; gap:12px; font-size:14px; text-decoration:none; color:white; }
...
<body>
    ...
    <div id="tab-dash" class="tab-content active-tab">
        ...
        <div class="card">
            ...
            <div id="activityFeed">Initialising Engine...</div>
        </div>
    </div>

    <div id="tab-vault" class="tab-content"><div class="card"><h3>🏛️ Vault</h3></div></div>
    <div id="tab-insights" class="tab-content"><div class="card"><h3>📊 Insights</h3></div></div>
    <div id="tab-security" class="tab-content"><div class="card"><h3>🛡️ Security</h3></div></div>
            ...
            try {
                ...
                feed.innerHTML = data.transactions.length ? data.transactions.map(t => \`
                    <div style="display:flex; justify-content:space-between; padding:12px 0; border-bottom:1px solid #f1f5f9;">
                        ...
                        <small style="color:\${t.status.includes('Successful') ? 'var(--accent)' : 'var(--red)'}">\${t.status}</small></span>
                    </div>
